...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "rounded-2xl h-full w-full p-4 overflow-hidden bg-[#f6f6ef] border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
                className
            )}
        >
...
export const CardDescription = ({
    ...
    return (
        <p
            className={cn(
                "mt-2 text-red-800 tracking-wide leading-relaxed text-sm",
                className
            )}
        >
            {children}
