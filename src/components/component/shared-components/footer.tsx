    ...
    return (
        <footer className="mt-auto flex items-center justify-between h-16 border-t border-black/10 px-3 sm:px-9 text-xs text-gray-700 bg-[#f6f6ef]">
            ...
            <div className="flex gap-x-3 sm:gap-x-8">
                ...
                <Link
                    href="https://github.com/henryczup/lax-grades"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-x-1 hover:text-gray-900 transition-colors"
                >
                    ...
                    <span><strong>View in GitHub</strong></span>
                </Link>
            </div>
        </footer>
    );
